...
export const digitalServices: DigitalServiceItem[] = [
  ...
  {
    title: "CGI & 3D",
    en: "CGI films, product visualisation, 3D environments, simulations and impossible-to-shoot visuals.",
  ...
  },
  {
    ...
    tr: "Üst düzey ürün filmleri, fotoğraflar, dijital packshotlar ve kampanyalar ile sürekli içerik akışları için üretilen görsel varlıklar.",
  },
  {
    title: "Short-Form Video",
    en: "Instagram Reels, TikTok, YouTube Shorts, cutdowns, vertical films and platform-specific edits designed for attention.",
    tr: "Instagram Reels, TikTok, YouTube Shorts, cutdownlar, dikey filmler ve dikkat çekmek için tasarlanmış platforma özel kurgular.",
  },
  {
    ...
    tr: "Tek fikir, çok format. Kanala özel sürümleri, cutdownları, oranları, dilleri ve varlık varyasyonlarını ölçekli üretiyoruz.",
  },
  {
    ...
    tr: "Key visuallar, kampanya filmleri, sosyal medya varlıkları, bannerlar, animasyonlar, dijital OOH ve lansman içerikleri.",
  },
];
